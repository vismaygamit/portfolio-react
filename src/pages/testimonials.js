            ...
            <div className="swiper-slide" key={index}>
              <div className="testimonial-box">
                <div className="author-test">
                  <img src={"/assets/img/"+val.img} alt="" className="rounded-circle b-shadow-a" />
