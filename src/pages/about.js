              ...
              <div className="row">
                ...
                <div className="col-sm-6 col-md-7">
                  <div className="about-info">
                    <p><span className="title-s">Name: </span> <span>Vismay Gamit</span></p>
                    <p><span className="title-s">Profile: </span> <span>Full stack developer</span></p>
                    <p><span className="title-s">Email: </span> <span>vismaygamit16@gmail.com</span></p>
                    <p><span className="title-s">Phone: </span> <span>+91 9601550***</span></p>
                  </div>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="about-me pt-4 pt-md-0 text-start">
                ...
                <p className="lead text-align-justify">
                  Hello! My name is Vismay Gamit, and I'am India-based freelancer.
                </p>
                <p className="lead text-align-justify">
                  I am a Fullstack Developer. I enjoy building everything from small business sites to rich interactive web apps. I am always hungry for learning new stuff and taking on new challenges.
                </p>
                <p className="lead text-justify">
                if you are a business seeking a web presence or an employer looking to hire, you can get in touch with me <a href="#contact">here</a>.
                </p>
              </div>
            </div>
          </div>
